...
function setup() {
	...
	chain1=new Chain(Bobobj2.body,Roof.body);
	chain1=new Chain(Bobobj3.body,Roof.body);
	chain1=new Chain(Bobobj4.body,Roof.body);
	chain1=new Chain(Bobobj5.body,Roof.body);
	Engine.run(engine);
